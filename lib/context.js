...
console.log('- Clean sender:', cleanSender);
...
console.log('- Settings owner number:', settings.ownerNumber);

console.log('- Message from me:', message.key.fromMe);
...
// Add this RIGHT AFTER the senderIsSudo line:

console.log('🔍 OWNER DEBUG:');

console.log('- senderNumber:', senderNumber);

console.log('- settings.ownerNumber:', settings.ownerNumber);

console.log('- global.ownerLid:', global.ownerLid);

console.log('- message.key.fromMe:', message.key.fromMe);

console.log('- senderIsSudo result:', senderIsSudo);
